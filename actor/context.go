...
func (ctx *defaultContext) System() *ActorSystem {
	return ctx.system
}
...
func newDefaultContext(sender, target *Pid, system *ActorSystem, msg interface{}, resp Response) Context {
...
func newProxyContext(system *ActorSystem, sender *Pid, target *Pid, msg interface{}, respond bool, conn *grpc.ClientConn) *proxyContext {
...
func (proxy *proxyContext) System() *ActorSystem {
	return proxy.system
}
...
func (proxy *proxyContext) Respond() bool {
